...
namespace SocialLife.Data.Migrations
{
    ...
    [Migration("20211230181831_AddExtensionAttributeToAttachmentsTable")]
    partial class AddExtensionAttributeToAttachmentsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialLife.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("SocialLife.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SocialLife.Data.Models.Attachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AttachedById")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SocialLife.Data.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SocialLife.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SocialLife.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SocialLife.Data.Models.Attachment", b =>
                {
                    b.HasOne("SocialLife.Data.Models.ApplicationUser", "AttachedBy")
                        .WithMany("Attachments")
                        .HasForeignKey("AttachedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SocialLife.Data.Models.Post", "Post")
                        .WithMany("Attachments")
            ...
            modelBuilder.Entity("SocialLife.Data.Models.Post", b =>
                {
                    b.HasOne("SocialLife.Data.Models.ApplicationUser", "Author")
                        .WithMany("Posts")
